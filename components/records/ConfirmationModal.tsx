...
export const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs animate-fadeIn">
      <div className="w-full max-w-lg rounded-2xl bg-white dark:bg-brand-surface border border-brand-border shadow-card p-6 overflow-hidden flex flex-col max-h-[90dvh]">
