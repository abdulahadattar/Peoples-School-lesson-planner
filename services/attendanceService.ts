...
export const DEFAULT_GRADE_ENROLLMENTS: ClassEnrollment[] = [
  { classKey: 'ECCE', romanName: 'KACHI', displayName: 'Early Childhood Education', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'I', romanName: 'I', displayName: 'Grade 1', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'II', romanName: 'II', displayName: 'Grade 2', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'III', romanName: 'III', displayName: 'Grade 3', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'IV-A', romanName: 'IV-A', displayName: 'Grade 4-A', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'IV-B', romanName: 'IV-B', displayName: 'Grade 4-B', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'V', romanName: 'V', displayName: 'Grade 5', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'VI-A', romanName: 'VI-A', displayName: 'Grade 6-A', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'VI-B', romanName: 'VI-B', displayName: 'Grade 6-B', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'VII', romanName: 'VII', displayName: 'Grade 7', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'VIII', romanName: 'VIII', displayName: 'Grade 8', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'IX', romanName: 'IX', displayName: 'Grade 9', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'X-A', romanName: 'X-A', displayName: 'Grade 10-A', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'X-B', romanName: 'X-B', displayName: 'Grade 10-B', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'XI', romanName: 'XI', displayName: 'Grade 11', enrolledBoys: 0, enrolledGirls: 0 },
  { classKey: 'XII', romanName: 'XII', displayName: 'Grade 12', enrolledBoys: 0, enrolledGirls: 0 },
];
